...
public class Amazon extends Chess {
    public Amazon(int x, int y, boolean isWhite, PImage sprite, List<Chess> chessList) {
...
//integer x and y to present the point of the chess img_x and img_y, chess--image
